<header class="site-header">
    <div class="container-fluid">
        ...
        <a href="#" class="site-logo">
            <img class="hidden-md-down" style="margin-left: 5px; margin-right: 45px" src="../../public/img/grtc.jpg" alt="../">
        </a>
                ...
                <div class="site-header-shown">
                    ...
                    <div class="dropdown user-menu">
                        <div class="dropdown dropdown-typical">
                            <a href="#" class="dropdown-toggle no-arr" style="color: #000;">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
                            ...
                            <a class="dropdown-item" href="https://grtc-docs.gitbook.io/grtc-helpdek-user-manual"  target="_blank"
                                <span class="font-icon glyphicon glyphicon-question-sign"></span>Ayuda</a>
