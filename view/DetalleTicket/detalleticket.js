...
function mostraryvalidar(id){
    ...
    $.post("../../controller/ticket.php?op=mostrar", { tick_id : id }, function (data) {
        ...
        $('#lblestado').html("Estado:  "+data.tick_estado);
        $('#lblnomusuario').html(data.usu_nom +' '+data.usu_ape);
        $('#lblfechcrea').html(data.fech_crea);

        $('#lblnomidticket').html("Detalle del Ticket - "+data.tick_id);
        if (data.tec_nom === "Pendiente" && data.tec_ape === "de asignar") {
            $('#lblusuasig').html("Pendiente de asignar");
        } else {
            $('#lblusuasig').html(data.tec_nom + ' ' + data.tec_ape);
        }
