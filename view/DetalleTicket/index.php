                ...
                <div class="tbl">
                    <div class="tbl-row">
                        <div class="tbl-cell">
                            ...
                            <div>
                                <b> Usuario: <span class="label label-pill label-primary" id="lblnomusuario"></span>
                                </b>
                            </div>
                        ...
                        <div style="margin-top: 12px;">
                            <b>Fecha Creación: <span class="label label-pill label-default" id="lblfechcrea"></span></b>
                            <b style="margin-left: 69px;" id="lblestado"></b>

                        </div>

                        <div style="margin-top: 19px; margin-left: 335px;">
                            <b> Técnico Asignado: <span class="label label-pill label-warning" id="lblusuasig"></span>
                            </b>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <fieldset class="form-group">
                            ...
                            <div class="summernote-theme-1">
                                <textarea id="tickd_descrip" name="tickd_descrip" class="summernote"
                                          name="name"></textarea>
                            </div>
                        </fieldset>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <button type="button" id="btnenviar" class="btn btn-rounded btn-inline btn-primary">Enviar
                        </button>
