...
class Usuario extends Conectar
{
    ...
    // todos los registros segun rol 1

    public function get_usuario_x_rol_1()
    {
        $conectar = parent::conexion();
        parent::set_names();
        $sql = "SELECT * FROM tm_usuario where est=1 and rol_id=1";
        $sql = $conectar->prepare($sql);
        $sql->execute();
        return $resultado = $sql->fetchAll();
    }
    ...
    /*TODO: Total de tickets asignado a tecnico */
    public function get_usuario_total_x_id_tecnico($usu_id)
    {
        $conectar = parent::conexion();
        parent::set_names();
    ...
    /*TODO: Total de tickets abiertos por tecnico */
    public function get_usuario_totalabierto_x_id_tecnico($usu_id)
    {
        $conectar = parent::conexion();
        parent::set_names();
    ...
    /*TODO: Total de tickets cerrados por tecnico */
    public function get_usuario_totalcerrado_x_id_tecnico($usu_id)
    {
        $conectar = parent::conexion();
        parent::set_names();
    ...
    /*TODO: Total de tickets por categoria segun tecnico*/
    public function get_usuario_grafico_x_tecnico($usu_id)
    {
        $conectar = parent::conexion();
        parent::set_names();
        $sql = "SELECT tm_categoria.cat_nom as nom,COUNT(*) AS total
    ...
    public function get_usuario_x_correo_excluyendo_id($usu_correo, $usu_id)
    {
        $conectar = parent::conexion();
        parent::set_names();
        $sql = "SELECT * FROM tm_usuario WHERE usu_correo = ? AND usu_id != ?";
        $sql = $conectar->prepare($sql);
        $sql->bindValue(1, $usu_correo);
        $sql->bindValue(2, $usu_id);
        $sql->execute();
